...
GiantStrength::GiantStrength(MinionPtr next) : EnchantmentDec{CardName::GiantStrength, 1, "", next} {}
...
Enrage::Enrage(MinionPtr next) : EnchantmentDec{CardName::Enrage, 2, "", next} {}
