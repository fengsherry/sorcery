...
Card* createCard(string cardName, Player* p) {
    ...
    else if (cardName == "Novice Pyromancer") card = new DefaultMinion(CardName::NovicePyromancer, 1, 0, 1, new NovicePyromancerAbility{}, "Deal 1 damage to target minion.");
    else if (cardName == "Apprentice Summoner") card = new DefaultMinion(CardName::ApprenticeSummoner, 1, 1, 1, new ApprenticeSummonerAbility{}, "Summon a 1/1 air elemental.");
    else if (cardName == "Master Summoner") card = new DefaultMinion(CardName::MasterSummoner, 3, 2, 3, new MasterSummonerAbility{}, "Summon up to three 1/1 air elementals.");
